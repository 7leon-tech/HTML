...
<h1>Selamat datang di EL Administrator</h1>
...
<td>".$kolom["penulis"]."</td>
<td>".$kolom["jumlah"]."</td>
<td><a href='updatebuku.php?kode_buku=".$kolom["kode_buku"]."'>update</a>|<a href='delete.php?kode_buku=".$kolom["kode_buku"]."'>delete</a> </td></tr>";}
?>
